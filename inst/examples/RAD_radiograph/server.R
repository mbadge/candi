function(input, output, session) {
    ...
    output$imgIdUi <- renderUI({
        selectInput("img_id", "Image:", choices=kAVAIL_TEST_IDS, )
    })

    # Clinical Outputs
    ## Radiograph
    output$radiographImage <- renderImage({
        filename <- stringr::str_interp("${kDIR_SMALL_IMGS}/${input$img_id}.jpg")

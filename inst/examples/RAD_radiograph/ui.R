fluidPage(
    ...
    div(id="title", align="center",
        titlePanel("CANDI Institutional Radiograph Annotation Dashboard", windowTitle=WindowTitle())),

    sidebarLayout(
        sidebarPanel(
            textInput("user_name", "User Name:", value = "Marcus"),
            uiOutput("imgIdUi"),   # Drop-down menu of all images files avail
            hr(),
    ...
    shinyjs::hidden(
        div(id="advanced",
            wellPanel(
                ...
                h2('Inputs'),
                shiny::tags$strong('img_id'), verbatimTextOutput('imgIdInPrint'),
                shiny::tags$strong('user_name'), verbatimTextOutput('userNamePrint'),

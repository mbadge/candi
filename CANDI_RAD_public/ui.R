    ...
    shinyjs::hidden(
        div(id="advanced",
            wellPanel(
                ...
                tags$strong('clinicalNoteDF'), verbatimTextOutput('clinicalNoteDFPrint')
            )
        )
    )
)
